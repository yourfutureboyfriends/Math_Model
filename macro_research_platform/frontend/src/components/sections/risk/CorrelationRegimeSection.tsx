...
export function CorrelationRegimeSection() {
  // Get correlation data from store
  const data = useMacroStore((state) => state.correlationRegime);
  ...
  return (
    <div id="correlation" className="terminal-section">
      ...
      <div className="section-header mb-3">
        ...
        <ComputedTag section="correlationRegime" />
      </div>
